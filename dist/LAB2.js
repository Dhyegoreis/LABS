...
class Empresa {
    ...
    atualizarSalario(matricula, salario) {
        ...
        const salarioAntigo = funcionario.salario;
...
function cadastrarFuncionarios(empresa) {
    ...
    const func1 = new Funcionario(101, "Ana Souza", "Desenvolvedora", 7500.00);
    const func2 = new Funcionario(102, "Carlos Lima", "Designer", 5800.00);
    const func3 = new Funcionario(103, "Mariana Costa", "Gerente de Projetos", 9200.00);
