...
class Hotel {
    ...
    registrarReserva(reserva) {
        const quartoOcupado = this.reservas.find(r => r.numeroQuarto === reserva.numeroQuarto);
        if (quartoOcupado) {
    ...
    cancelarReserva(numeroQuarto) {
        ...
        const reservaCancelada = this.reservas[index];
    ...
    consultarStatusQuarto(numeroQuarto) {
        ...
        if (reserva) {
            ...
            const entrada = reserva.dataEntrada.toLocaleDateString("pt-BR");
            const saida = reserva.dataSaida.toLocaleDateString("pt-BR");
...
function registrarReservas(hotel) {
    ...
    const reserva1 = new Reserva(101, "João Silva", new Date("2025-06-10"), new Date("2025-06-15"));
    const reserva2 = new Reserva(202, "Fernanda Oliveira", new Date("2025-06-12"), new Date("2025-06-18"));
    const reserva3 = new Reserva(303, "Roberto Santos", new Date("2025-06-20"), new Date("2025-06-25"));
...
function cancelarReserva(hotel, numeroQuarto) {
    console.log("\n --- Cancelando reserva ---");
    try {
...
function consultarStatusQuarto(hotel, numeroQuarto) {
...
console.log("\n --- Registrando reservas ---");
try {
    const reservaDuplicada = new Reserva(202, "Carlos Mendes", new Date("2025-06-13"), new Date("2025-06-16"));
